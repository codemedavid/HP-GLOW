...
const AdminDashboard: React.FC = () => {
  ...
  const [currentView, setCurrentView] = useState<'dashboard' | 'products' | 'add' | 'edit' | 'categories' | 'payments' | 'coa' | 'inventory' | 'orders' | 'vouchers' | 'faq'>('dashboard');
            ...
            <div className="bg-white rounded-lg md:rounded-xl shadow-lg p-3 md:p-4 border border-gold-300/30">
              ...
              <div className="space-y-1 md:space-y-1.5">
                ...
                >
                  ...
                  <span className="text-xs font-medium text-gray-900">Vouchers</span>
                </button>
                <button
