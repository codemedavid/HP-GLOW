...
import { MessageCircle, Shield, Heart, Sparkles, Phone } from 'lucide-react';
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-6 max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap items-center gap-2 md:gap-3 justify-center md:justify-start">
            ...
            <a
              ...
              className="flex items-center gap-2 bg-gradient-to-r from-purple-600 to-purple-700 hover:from-purple-700 hover:to-purple-800 text-white px-3 py-2 md:px-4 md:py-2 rounded-lg transition-all font-medium text-xs md:text-sm shadow-md hover:shadow-lg transform hover:scale-105"
            >
              <Phone className="w-3 h-3 md:w-4 md:h-4" />
              <span className="hidden sm:inline">Viber: {viberNumber}</span>
              <span className="sm:hidden">{viberNumber}</span>
            </a>
